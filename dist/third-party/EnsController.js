 ...
 */
class EnsController extends BaseController_1.default {
    /**
    ...
    set(chainId, ensName, address) {
        if (!Number.isInteger(Number.parseInt(chainId, 10)) ||
            ...
            (address && !ethereumjs_util_1.isValidAddress(address))) {
        ...
        const normalizedAddress = address ? ethereumjs_util_1.toChecksumAddress(address) : null;
